...
const exportRecipeToJSON = async (recipeData) => {
    try {
        ...
        try {
            const saveResponse = await fetch('http://localhost:5000/api/save-recipe', {
                method: 'POST',
                headers: {
            ...
            console.error('Backend save failed, but recipe is saved in localStorage:', error)
        }
...
<template>
    <div class="create-page" data-v-inspector="src/views/CreateView.vue:191:5">
        <div class="create-content" data-v-inspector="src/views/CreateView.vue:192:9">
            <h1 data-v-inspector="src/views/CreateView.vue:193:13">Create a New Recipe</h1>

            <!-- Success/Error Messages -->
            <div v-if="submitSuccess" class="success-message" data-v-inspector="src/views/CreateView.vue:196:13">
                {{ submitSuccess }}
            </div>
            <div v-if="submitError" class="error-message" data-v-inspector="src/views/CreateView.vue:199:13">
                {{ submitError }}
            </div>

            <form @submit.prevent="submitRecipe" class="recipe-form" data-v-inspector="src/views/CreateView.vue:203:13">
                <!-- Image Upload Section -->
                <div class="form-section" data-v-inspector="src/views/CreateView.vue:205:17">
                    <h2 data-v-inspector="src/views/CreateView.vue:206:21">Recipe Image</h2>
                    <ImageUpload v-model:image="recipeData.image" data-v-inspector="src/views/CreateView.vue:207:21" />
                </div>

                <!-- Recipe Name Section -->
                <div class="form-section" data-v-inspector="src/views/CreateView.vue:211:17">
                    <h2 data-v-inspector="src/views/CreateView.vue:212:21">Recipe Name</h2>
                    <RecipeNameInput v-model="recipeData.name" data-v-inspector="src/views/CreateView.vue:213:21" />
                </div>

                <!-- Tags Section -->
                <div class="form-section" data-v-inspector="src/views/CreateView.vue:217:17">
                    <h2 data-v-inspector="src/views/CreateView.vue:218:21">Tags</h2>
                    <TagsInput v-model="recipeData.tags" data-v-inspector="src/views/CreateView.vue:219:21" />
                </div>

                <!-- Ingredients Section -->
                <div class="form-section" data-v-inspector="src/views/CreateView.vue:223:17">
                    <h2 data-v-inspector="src/views/CreateView.vue:224:21">Ingredients</h2>
                    <IngredientsTable v-model="recipeData.ingredients" data-v-inspector="src/views/CreateView.vue:225:21" />
                </div>

                <!-- Instructions Section -->
                <div class="form-section" data-v-inspector="src/views/CreateView.vue:229:17">
                    <h2 data-v-inspector="src/views/CreateView.vue:230:21">Instructions</h2>
                    <InstructionsInput v-model="recipeData.instructions" data-v-inspector="src/views/CreateView.vue:231:21" />
                </div>

                <!-- Submit Button -->
                <div class="form-section" data-v-inspector="src/views/CreateView.vue:235:17">
                    <button type="submit" class="submit-btn" :disabled="isSubmitting" data-v-inspector="src/views/CreateView.vue:236:21">
